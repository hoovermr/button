...
################## BEGIN CUSTOM FUNCTIONS ##################
    ...
    def create_collection(self):
        """ :reference: https://developer.twitter.com/en/docs/tweets/curate-a-collection/api-reference/post-collections-create
            :allowed_param:'name', 'description', 'url', 'timeline_order'
        """
    ...
    def curate_collection(self, *args, **kwargs):
        """ :reference: https://developer.twitter.com/en/docs/tweets/curate-a-collection/api-reference/post-collections-entries-curate
            :allowed_param: None
        """
        return bind_api(
            api=self,
            ...
            allowed_param=[],
            require_auth=True
        )(post_data=dumps(kwargs), *args, **kwargs)
